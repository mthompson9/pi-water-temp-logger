...
#Path to save CSV to
csv_filepath = '/home/pi/temp-logger-csvfiles/'

#Locate and open/create the CSV file
csv_file = os.path.join(csv_filepath,filename  + ".csv")
error_file = os.path.join(csv_filepath,errorlog  + ".csv")
...
firebase_url = 'https://temperature-monitor-pi.firebaseio.com' 
time.sleep(5)
...
try:    
    ...
    appendfile = open(error_file, 'a') #opens the file for ammending
